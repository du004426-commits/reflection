...
export type Project = { id: string; name: string; startedAt: string; completedAt?: string; status: ProjectStatus; chatgptProjectUrl?: string; reflectionCadence?: ReflectionCadence; nextCheckIn?: string; clientName?: string; companyName?: string; companyType?: string; projectType?: string; amount?: string; progress?: number; nextAction?: string; nextActionAt?: string };
